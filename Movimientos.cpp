...
void Movimientos::guardarPartida(string rutaArchivo)
{

  /* //guardarTablero();
   for(int i=0;i<3;i++)
   {
    vector[i]=ejercito_1[i];
   }
   for(int i=3;i<6;i++)
   {
     vector[i]=ejercito_2[i-3];
   }
  ...
  vector<Personajes>::iterator *iterador;

  for(iterador=ejercito_1[0]; iterador!=ejercito_1[2];iterador++)
  {
    outputfile<<*iterador<<endl;
  }
  outputfile.close();
}*/
/*void Movimientos::cargarPartida()
{
   for(int i=0; i<3; i++)
   {
     ejercito_1[i]=vector[i];
   }

   for(int i=3;i<6;i++)
   {
     ejercito_2[i-3]=vector[i];
   }*/
}
